...
public class SmsBroadcastReceiver extends BroadcastReceiver {
    ...
    public class MalibuCountDownTimer extends CountDownTimer{
		...
		public void onFinish() {
			...
			if(((location.getLatitude() - 0.01) < newLocation.getLatitude()) &&
				(newLocation.getLatitude() < (location.getLatitude() + 0.01)) && 
				(location.getLongitude() - 0.01 < newLocation.getLongitude()) &&
				(newLocation.getLongitude() < (location.getLongitude() + 0.01)))
