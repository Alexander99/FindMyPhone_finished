...
import com.example.findmyphone.SmsBroadcastReceiver;
import com.example.findmyphone.EditsPageActivity;
...
//	File file;
	...
	AlertDialog.Builder alertDefaultSms;
  ...
  //DEFINING A STRING ADAPTER WHICH WILL HANDLE THE DATA OF THE LISTVIEW
    ...
    public void SAVEPHRASE(View view){
    	...
    	String temp = PassPhrase.getText().toString();
    	...
    	//Write to edit text, rather than toast it
    	PassPhrase.setText("");
    	PassPhrase.setHint("Just set "+temp+" As PassPhrase");
    }
    
   public void EDITNUMBERS(View view){
	   //editnumbers button should take us to EditsPageActivity, where we can add or delete
	   //numbers we select from a list
	   Intent jumpIntent = new Intent(this, EditsPageActivity.class);
