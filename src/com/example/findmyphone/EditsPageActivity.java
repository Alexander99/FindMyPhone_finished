...
public class EditsPageActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			//make sure to load the passphrase so the receiver works on this page!
			FileInputStream fin1 = openFileInput("mydata");
			int c;
			String temp="";
	...
	public void ADDNUMBER(View view){
		...
		//Save the number used to the internal data; whenever created, this data
		 ...
		 AddDelNum.setText("");
		 AddDelNum.setHint("Added contact at "+addNumber);
	}
...
//			Toast.makeText(this,PhoneNos.indexOf(delNumber),Toast.LENGTH_LONG).show();
		 ...
		 PhoneNos.remove(PhoneNos.size()-1);
			...
			AddDelNum.setText("");
			AddDelNum.setHint("Removed contact at "+delNumber);
		}
